<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="EditVisitor.aspx.cs" Inherits="GWICApp.Main.EditVisitor" %>
     ...
     <div class="wrapper wrapper-content animated fadeInRight">
                <div class="ibox float-e-margins">
                 ...
                 <div class="row">
                    ...
                    <asp:Button ID="btnUpdate" CssClass="btn btn-primary" runat="server" Text="Save" CausesValidation="true" OnClick="btnUpdate_Click" />         
                </div>
                    </ContentTemplate>
                </asp:UpdatePanel>
                    </div>
