...
namespace GWICApp.Reports.Members {
    ...
    public class rptByGender : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "GWICApp.Reports.Members.rptByGender.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedrptByGender : Component, ICachedReport {
        
        public CachedrptByGender() {
        }
